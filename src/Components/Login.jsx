...
//        if(email &&password){
//    fetch("https://lonely-purse-colt.cyclic.app/user/login", {
//      method : "POST",
 ...
 // }
    return (
      <div>
        ...
        <input type="text" placeholder='Email' style={{color:"black", padding:"5px"}} onChange={(e)=>{setCredential({...credential,email:e.target.value})}}/>
        <br />
        ...
        <br /><br />
        <button style={{color:"black",padding:"5px"}} >Login</button>
                                                   {/* onClick={handlelogin} */}
        <br />                                       
        <br />
